...
Program used to parse the timings of loggings
'''
...
def main(argv=None):
    ...
    ParsArg = ArgumentParser(description=DESCRIPTION)
    ParsArg.add_argument("--file", default="verit.log")
    ParsArg.add_argument("--print_lines", default=False, action="store_true")
    ParsArg.add_argument("--pattern", default=None)

    args = ParsArg.parse_args(argv)
